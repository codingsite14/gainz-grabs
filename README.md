[code.txt](https://github.com/user-attachments/files/24368277/code.txt)
...
const Marquee = () => (
  <div className="bg-lime-400 text-black py-3 overflow-hidden whitespace-nowrap border-y-2 border-black">
    <div className="animate-marquee inline-block font-black uppercase tracking-widest text-sm md:text-base">
      <span className="mx-4">Eat Clean. Train Hard.</span> • 
      <span className="mx-4">No Added Sugar.</span> • 
      <span className="mx-4">High Protein.</span> • 
      <span className="mx-4">100% Natural.</span> • 
      <span className="mx-4">Gym Integrated.</span> • 
      <span className="mx-4">Eat Clean. Train Hard.</span> • 
      <span className="mx-4">No Added Sugar.</span> • 
      <span className="mx-4">High Protein.</span> • 
    </div>
        ...
        <div className="md:w-1/2 flex flex-col justify-center px-6 md:px-20 py-20 relative z-10">
          <div className="mb-8">
            ...
            <p className="text-xl text-gray-600 max-w-md font-medium border-l-4 border-lime-400 pl-6 mb-6">
              The only café designed for the dedicated. Precision nutrition meets gourmet taste inside your favorite gyms.
            </p>
             ...
             <div className="grid md:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <p className="text-gray-400 text-lg mb-8 max-w-lg">
                    Join the fastest growing fitness café network in India. Low overhead, high retention, and a community that eats here everyday.
                  </p>
      ...
      <div className="bg-lime-400 py-24 px-6">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-xl md:text-2xl font-bold mb-8 text-gray-800">
            India's First Dedicated Gym-Café Franchise Model.
          </p>
        ...
        <div className="flex flex-col md:flex-row gap-12 mb-24">
          <div className="md:w-1/2">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              Gainz & Grabs was born from a simple necessity: Real food, real macros, real fast. We aren't just a café; we are a nutritional support system for athletes, bodybuilders, and anyone trying to live healthier.
            </p>
          </div>
          <div className="md:w-1/2">
      ...
      <nav className="fixed w-full z-50 bg-white/95 backdrop-blur border-b border-gray-200">
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-black text-white absolute top-20 left-0 w-full min-h-screen p-8 flex flex-col gap-8">
            ...
            <button onClick={() => { setIsCoachOpen(true); setIsMenuOpen(false); }} className="text-3xl font-black uppercase text-left text-lime-400">✨ AI Smart Coach</button>
          </div>
        )}
      </nav>
